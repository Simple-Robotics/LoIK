...
namespace loik
{
  ...
  IkIdDataTypeOptimizedTpl<_Scalar, _Options, JointCollectionTpl>::IkIdDataTypeOptimizedTpl(const Model& model)
  ...
  ///
  template< typename _Scalar, int _Options, template< typename S, int> class JointCollectionTpl >
  IkIdDataTypeOptimizedTpl<_Scalar, _Options, JointCollectionTpl>::IkIdDataTypeOptimizedTpl(const Model& model, const int num_eq_c)
    : joints(0), 
      ...
      delta_w_inf_norm(0.0)
  {
      ...
      {
        // create joint datas
        joints.push_back(pinocchio::CreateJointData<_Scalar, _Options, JointCollectionTpl>::run(model.joints[i]));
  ...
  bool operator == (const IkIdDataTypeOptimizedTpl<Scalar, Options, JointCollectionTpl>& ik_id_data_1, 
                    const IkIdDataTypeOptimizedTpl<Scalar, Options, JointCollectionTpl>& ik_id_data_2)
  {
    bool value = ik_id_data_1.joints == ik_id_data_2.joints 
                ...
                && ik_id_data_1.delta_fis == ik_id_data_2.delta_fis
                && ik_id_data_1.yis == ik_id_data_2.yis
                && ik_id_data_1.delta_yis == ik_id_data_2.delta_yis
                && ik_id_data_1.w == ik_id_data_2.w
                && ik_id_data_1.delta_w == ik_id_data_2.delta_w
                ...
                && ik_id_data_1.delta_fis_diff_plus_Aty_inf_norm == ik_id_data_2.delta_fis_diff_plus_Aty_inf_norm
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief utility function for defining symmetric operator "==" overload between IkIdData and Data
  ///
  template< typename Scalar, int Options, template< typename S, int O> class JointCollectionTpl >
  bool CompareDataIkIdData (const IkIdDataTypeOptimizedTpl<Scalar, Options, JointCollectionTpl>& ik_id_data, 
                            const pinocchio::DataTpl<Scalar, Options, JointCollectionTpl>& data)
  {
    bool value = ik_id_data.oMi == data.oMi 
                && ik_id_data.liMi == data.liMi;
  ...
  ///
  template<typename Scalar, int Options, template<typename S, int O> class JointCollectionTpl >
  bool operator == (const IkIdDataTypeOptimizedTpl<Scalar, Options, JointCollectionTpl>& ik_id_data, 
                    const pinocchio::DataTpl<Scalar, Options, JointCollectionTpl>& data) 
  {
  ...
  template<typename Scalar, int Options, template<typename S, int O> class JointCollectionTpl >
  bool operator == (const pinocchio::DataTpl<Scalar, Options, JointCollectionTpl>& data, 
