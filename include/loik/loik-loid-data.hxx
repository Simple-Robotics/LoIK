...
///
template< typename _Scalar, int _Options, template< typename S, int> class JointCollectionTpl >
IkIdDataTpl<_Scalar, _Options, JointCollectionTpl>::IkIdDataTpl(const Model& model, const int eq_c_dim)
  : joints(0), 
...
bool operator == (const IkIdDataTpl<Scalar, Options, JointCollectionTpl>& ik_id_data_1, 
                  const IkIdDataTpl<Scalar, Options, JointCollectionTpl>& ik_id_data_2)
{
  bool value = ik_id_data_1.joints == ik_id_data_2.joints 
               ...
               && ik_id_data_1.Si_nui_s == ik_id_data_2.Si_nui_s
               ...
               && ik_id_data_1.pis == ik_id_data_2.pis
               && ik_id_data_1.Dis == ik_id_data_2.Dis
               && ik_id_data_1.Di_invs == ik_id_data_2.Di_invs
               && ik_id_data_1.Ris == ik_id_data_2.Ris
               && ik_id_data_1.ris == ik_id_data_2.ris
...
///
template< typename Scalar, int Options, template< typename S, int O> class JointCollectionTpl >
bool CompareDataIkIdData (const IkIdDataTpl<Scalar, Options, JointCollectionTpl>& ik_id_data, 
...
///
template<typename Scalar, int Options, template<typename S, int O> class JointCollectionTpl >
bool operator == (const IkIdDataTpl<Scalar, Options, JointCollectionTpl>& ik_id_data, 
                  const pinocchio::DataTpl<Scalar, Options, JointCollectionTpl>& data) 
{
