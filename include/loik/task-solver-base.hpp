...
namespace loik
{
  ...
  struct IkIdSolverBaseTpl
  {
      ...
      IkIdSolverBaseTpl(const int max_iter, const Scalar& tol_abs, const Scalar& tol_rel, const Scalar& tol_primal_inf, const Scalar& tol_dual_inf,
      ...
      inline bool get_primal_infeasibility_status() const { return primal_infeasible_; };

      /// \brief get dual infeasibility status at the last finished iteration
      inline bool get_dual_infeasibility_status() const { return dual_infeasible_; };
      ...
      inline void set_tol_primal(const Scalar tol_primal) { this->tol_primal_ = tol_primal; };
      ...
      inline void set_tol_dual(const Scalar tol_dual) { this->tol_dual_ = tol_dual; };
      ...
      inline void set_tol_primal_inf(const Scalar tol_primal_inf) {this->tol_primal_inf_ = tol_primal_inf; };
      ...
      inline void set_tol_dual_inf(const Scalar tol_dual_inf) {this->tol_dual_inf_ = tol_dual_inf; };
